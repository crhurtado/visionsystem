...
<div id="contenedor">
    ...
    <div class="primary">
        ...
        <div id="slider">
        	<img src="img/presupuesto.jpg" title="Presupuesto | Vision System C.A." style="width:100%; max-height: 80px;"/>
        </div>
        <div class="flex filajust">
            <div id="contenido">
                                           
                <div class="separador"> Solicitud de Presupuesto</div>
                
                <?php include ('source/presupuesto.php') ?>                
